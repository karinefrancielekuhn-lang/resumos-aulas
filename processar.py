...
O que faz sozinho:
  ...
  - varre audio/ e processa só o que ainda NÃO tem .txt em transcricao/;
  ...
  - salva transcricao/<nome>.txt, uma linha por segmento: [HH:MM:SS] texto;
...
DIR_TRANSCRICAO = RAIZ / "transcricao"
...
def main() -> int:
    ...
    fila = pendentes()
    if not fila:
        print("Nada a fazer: toda gravação em audio/ já tem transcrição.")
        return 0
